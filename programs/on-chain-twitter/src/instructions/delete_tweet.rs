...
pub struct DeleteTweet <'info>{
    ...
    //#[account(mut, has_one = author, seeds = [b"tweet-account".as_ref(), author.key().as_ref(),&tweet.tweet_number.to_le_bytes()], bump= twitter_user.bump, close = author)]
    #[account(
        mut, 
        seeds = [b"tweet-account".as_ref(), author.key().as_ref(), tweet.tweet_number.to_le_bytes().as_ref()], 
        bump= tweet.bump, 
        close = author
    )]
    //#[account(mut, seeds = [b"tweet-account".as_ref(), author.key().as_ref(),&[twitter_user.tweet_count]], bump= twitter_user.bump, close = author)]
